...
%---------------------------------------------------------
  \cventry
   {\href{https://limeblossomjams.itch.io/whenever-the-door-opens}{https://limeblossomjams.itch.io/whenever-the-door-opens}} % Subheading
    {Whenever} % Project name
    {Brackeys Jam 2024.1} % Location
    {Feb. 2024, 7 days} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
